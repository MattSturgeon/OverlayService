...
ln -s "$(realpath ./builddir/overlay-service)" /usr/bin/overlay-service
...
ln -s "$(realpath ./dbus.conf)" /usr/share/dbus-1/system.d/org.github.MattSturgeon.OverlayService.conf
...
ln -s "$(realpath ./dbus.service)" /usr/share/dbus-1/system-services/org.github.MattSturgeon.OverlayService.service
...
ln -s "$(realpath ./systemd.service)" /usr/lib/systemd/system/overlay.service